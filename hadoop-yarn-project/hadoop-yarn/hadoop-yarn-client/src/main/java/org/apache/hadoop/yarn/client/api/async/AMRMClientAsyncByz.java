...
import org.apache.hadoop.yarn.client.api.async.impl.AMRMClientAsyncByzImpl;
 ...
 * completions, This class provides Byzantine fault tolerance at the container level when used
 * in conjunction with NMClientAsyncByz.
 *
 * It contains a thread that sends periodic heartbeats to the
 * ResourceManager.
 * 
 * It should be used by implementing a CallbackHandler:
 * <pre>
 * {@code
 * class MyCallbackHandler implements AMRMClientAsyncByz.CallbackHandler {
 ...
 * <pre>
 * {@code
 * AMRMClientAsyncByz asyncClient = 
...
extends Byzantine{
  ...
  public static <T extends ContainerRequest> AMRMClientAsyncByz<T>
      createAMRMClientAsync(int intervalMs, CallbackHandler callbackHandler) {
    return new AMRMClientAsyncByzImpl<T>(intervalMs, callbackHandler);
  }
  
  public static <T extends ContainerRequest> AMRMClientAsyncByz<T>
      createAMRMClientAsync(AMRMClient<T> client, int intervalMs,
          CallbackHandler callbackHandler) {
    return new AMRMClientAsyncByzImpl<T>(client, intervalMs, callbackHandler);
  }
  
  protected AMRMClientAsyncByz(int intervalMs, CallbackHandler callbackHandler) {
