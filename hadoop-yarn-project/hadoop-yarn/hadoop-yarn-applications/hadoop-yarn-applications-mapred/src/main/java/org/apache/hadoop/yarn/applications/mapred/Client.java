...
public class Client {
  ...
  public Client(Configuration conf) throws Exception  {
    this(
      "org.apache.hadoop.yarn.applications.mapred.ApplicationMaster",
      conf);
  }
  ...
  public boolean init(String[] args) throws ParseException {
    ...
    numMappers = Integer.parseInt(cliParser.getOptionValue("num_mappers", "1"));
    numReducers = Integer.parseInt(cliParser.getOptionValue("num_reducers", "1"));

    numContainers = numMappers+numReducers;
  ...
  public boolean run() throws IOException, YarnException {
    ...
    vargs.add("--num_mappers " + String.valueOf(numMappers));
    vargs.add("--num_reducers " + String.valueOf(numReducers));
