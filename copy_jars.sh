...
if [[ $1 == 'client' ]]; then
    ...
    cd $HADOOP_YARN_SRC/hadoop-yarn/hadoop-yarn-applications/hadoop-yarn-applications-mapred/
    mvn package -DskipTests

    echo cp $HADOOP_YARN_SRC/hadoop-yarn/hadoop-yarn-applications/hadoop-yarn-applications-mapred/target/hadoop-yarn-applications-mapred-3.0.0-SNAPSHOT.jar $HADOOP_PREFIX/share/hadoop/yarn
    cp $HADOOP_YARN_SRC/hadoop-yarn/hadoop-yarn-applications/hadoop-yarn-applications-mapred/target/hadoop-yarn-applications-mapred-3.0.0-SNAPSHOT.jar $HADOOP_PREFIX/share/hadoop/yarn
    
    echo cp $HADOOP_YARN_SRC/hadoop-yarn/hadoop-yarn-applications/hadoop-yarn-applications-mapred/*.py $HADOOP_PREFIX/
    cp $HADOOP_YARN_SRC/hadoop-yarn/hadoop-yarn-applications/hadoop-yarn-applications-mapred/*.py $HADOOP_PREFIX/
